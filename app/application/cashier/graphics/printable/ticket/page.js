                ...
                [...new Array(ticketInfos.quantity)].map(function(item, index){
                  ...
                  return (
                    <Page key={item} orientation={printableModel.orientation} style={styles.page}>
                      ...
                      <Text style={styles.elementBStyle}> Ticket : { serial } / { ticketInfos.category } - Siège : {ticketInfos.positionCode } </Text>
                      <Text style={styles.elementCStyle}> Prix : { ticketInfos.positionPrice } DH / { ticketInfos.allowedScanNumber } Scan(s) </Text>
