...
export default function Dashboard(props) {
  ...
  const loadCreatePage = function(event, id){
    ...
    router.replace('/application/manager/zones/create')
  }

  const loadUpdatePage = function(event, id){
    event.preventDefault()
    router.push("/application/manager/zones/update?id=".concat(id))
  }

  const loadReadPage = function(event, id){
    event.preventDefault()
    router.push("/application/manager/zones/read?id=".concat(id))
  }

  const loadDeletePage = function(event, id){
    event.preventDefault()
    router.push("/application/manager/zones/delete?id=".concat(id))
  }
