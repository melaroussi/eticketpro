      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, width: { xs : '100%', sm: `calc(100% - ${DRAWER_WIDTH}px)`} }}>
        ...
        <Container maxWidth={'xs'}>
          ...
          <Card sx={{ display: 'flex', flexDirection: 'column' }}>
            <CardHeader avatar={<Avatar sx={{ bgcolor: blue[600] }} variant="rounded"><StorageIcon /></Avatar>} title="Gestion des articlees" subheader="Fiche article" />
              ...
              <Stack spacing={2}>
                ...
                </Typography>
                {
                  article && <Stack spacing={0}>
                    ...
                    <Typography variant='button'>TVA (%) : { article.VATRate}</Typography>
                    ...
                    <Typography variant='button'>Description : { article.description }</Typography>
                  </Stack>
                }
                <Stack spacing={0}>
