            ...
            <CardContent spacing={2}>
              {/** Section InputTexts */}
              {
                !loading && <Stack spacing={2}>
                  ...
                  <Stack spacing={2}>
                    <TextField value={reference} defaultValue={reference} onChange={handleReference} variant='outlined' size='small' label="Réference" autoFocus required fullWidth InputLabelProps={{ shrink: true }}/>
                    <TextField value={label} defaultValue={label} onChange={handleLabel} variant='outlined' size='small' label="Label" required fullWidth InputLabelProps={{ shrink: true }}/>
                    <TextField value={category} defaultValue={category} onChange={handleCategory} variant='outlined' size='small' label="Catégorie" required fullWidth InputLabelProps={{ shrink: true }} select>
                      {
                    ...
                    <TextField value={warehousing} defaultValue={warehousing} onChange={handleWarehousing} variant='outlined' size='small' label="Suivi du Stock" required fullWidth InputLabelProps={{ shrink: true }} select>
                      {
                    ...
                    <TextField value={price} defaultValue={price} onChange={handlePrice} variant='outlined' type='number' size='small' label="Prix (HT)" required fullWidth InputLabelProps={{ shrink: true }}/>
                    <TextField value={VATRate} defaultValue={VATRate} onChange={handleVATRate} variant='outlined' type='number' size='small' label="TVA (%)" required fullWidth InputLabelProps={{ shrink: true }}/>
                    <TextField value={availableQuantity} defaultValue={availableQuantity} onChange={handleAvailableQuantity} variant='outlined' type='number' size='small' label="Quantité en Stock" required fullWidth InputLabelProps={{ shrink: true }}/>
                    <TextField value={description} defaultValue={description} onChange={handleDescription} multiline={true} rows={2} inputProps={{ maxLength: 100 }} variant='outlined' size='small' label="Description" fullWidth InputLabelProps={{ shrink: true }}/>      
                  </Stack>
