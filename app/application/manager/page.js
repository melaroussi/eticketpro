...
export default function Dashboard(props) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <NavigationSystem indicator={"manager-welcome"} element={"Bienvenue"}/>
            ...
            <Container maxWidth="md">
              <Stack direction={"column"} justifyContent={"center"} alignItems={"center"} >
                ...
                <Typography variant="body1" align="center">
                  Bienvenue dans l'espace d'administration de la billetterie du Zoo de Rabat ! Ensemble, rendons chaque visite exceptionnelle. L'équipe du Zoo de Rabat
                </Typography>
                {
                  onlineUser && <Typography variant="bodyh6">
