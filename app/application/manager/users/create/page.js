            ...
            <CardContent spacing={2}>
              ...
              <Collapse in={validationAlert}>
                ...
                <TextField value={firstName} onChange={handleFirstName} variant='outlined' size='small' label="Nom" autoFocus required fullWidth InputLabelProps={{ shrink: true }}/>
                  ...
                  <TextField value={departmentId} onChange={handleDepartmentId} variant='outlined' size='small' label="Département" required fullWidth InputLabelProps={{ shrink: true }} select id="department-select">
                    {
                  ...
                  <TextField value={status} onChange={handleStatus} variant='outlined' size='small' label="Status" required InputLabelProps={{ shrink: true }} id="status-select" select>
                    <MenuItem value={"Inactif"}>Inactif</MenuItem>
                    <MenuItem value={"Actif"}>Actif</MenuItem>
                  </TextField>
                  <TextField value={type} onChange={handleType} variant='outlined' size='small' label="Type" required InputLabelProps={{ shrink: true }} id="type-select" select>
