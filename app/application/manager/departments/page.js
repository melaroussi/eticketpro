...
export default function Dashboard(props) {
  ...
  const loadCreatePage = function(event, id){
    ...
    router.replace('/application/manager/departments/create')
  }

  const loadUpdatePage = function(event, id){
    event.preventDefault()
    router.push("/application/manager/departments/update?id=".concat(id))
  }

  const loadReadPage = function(event, id){
    event.preventDefault()
    router.push("/application/manager/departments/read?id=".concat(id))
  }

  const loadDeletePage = function(event, id){
    event.preventDefault()
    router.push("/application/manager/departments/delete?id=".concat(id))
  }
